...
<head>
	...
	<title>School Subject To Class</title>
									 ...
									 <div class="col-md-6 col-lg-6 col-sm-12">
									   <div class="form-group">						
										...
										<select name="subject_id" id="subject_id" class="form-control">
											 <?php foreach($data = $subjecttoclass->getAllSubjects() as $d){?>
									   ...
									   <div class="form-group">						
										...
										<div class="col-md-10">
										  <select name="unit_id" id="unit_id" class="form-control">
											 <?php foreach($data = $subjecttoclass->getAllUnits() as $d){?>
											   <?php if(!empty($d) && $d->name !=="" && $d->description !=="") {?>
											   <option value= <?php echo $d->id;?>> 							  
													<?php echo $d->name;?>				   
								...
								<div class="row">
									 <div class="col-md-6 col-lg-6 col-sm-12">
									   <div class="form-group">						
										...
										<div class="col-md-10">
										  <input type="text" name="subjectname" id="subjectname" class="form-control" placeholder="School Level Name">
									   </div>
									  </div>
									 </div>
				  ...
				  <div class="row">
							 ...
							 <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="unitname_edit" id="unitname_edit" class="form-control">
							   </div>
                              </div>
					         </div>
						</div>
								...
								<div class="row">
									 <div class="col-md-6 col-lg-6 col-sm-12">
									   <div class="form-group">						
										<label class="col-md-2 col-form-label">Subject Name</label>
										<div class="col-md-10">
										  <input type="text" name="subjectname_edit" id="subjectname_edit" class="form-control" placeholder="School Level Name">
									   </div>
									  </div>
									 </div>
					...
					<div class="modal fade" id="Modal_Delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog" role="document">
						<div class="modal-content">
						  ...
						  <div class="modal-footer">
							<input type="hidden" name="subjecttoclass_id_delete" id="subjecttoclass_id_delete" class="form-control"> <!-- please change this modal id to your own id-->
...
<script type="text/javascript">
    $(document).ready(function(){
	  ...
	  <!-- please edit from here -->		 		
		 function show(){
						$.ajax({
						   type  : 'ajax',
						   url   : 'selectallsubjecttoclass.php', 
						   async : false,
						   dataType : 'json',
							  ...
							  var html = '';
								 ...
								 for(i=0; i<data.length; i++){ 
									...
									html += '<tr>'+
										...
										'<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-id="'+data[i].id+'" data-name="'+data[i].name+'" data-category="'+data[i].category +'" data-subject_id="'+data[i].subject_id+'" data-unit_id="'+data[i].unit_id+'" data-unitname="'+data[i].unitname+'" data-subjectname="'+data[i].subjectname+'">Edit</a>'+' '+
  ...
  // start of save functions
                     $('#btn_save').on('click',function(){
							  ...
							  $.ajax({
								type : "POST",
								url  : "addsubjecttoclass.php", 
								dataType : "JSON",
								data:{name:name, subject_id :subject_id, unit_id:unit_id, unitname:unitname, subjectname:subjectname, category:category},
								success:function(data){
								  $('#session_id').val('');
							      $('#sessionname').val('');
							       $('#term_id').val('');
...
$('#btn_update').on('click',function(){
 ...
 var subject_id_edit = $('#subject_id_edit').val();
  ...
  var unitname_edit =$('#unitname_edit').val();
   ...
   $.ajax({
    type : "POST",
     url  : "updatesubjecttoclass.php",
    dataType : "JSON",
    data : {id:id_edit , name:name_edit, subject_id :subject_id_edit, unit_id:unit_id_edit, subjectname:subjectname_edit, category:category_edit, unitname:unitname_edit},
     success: function(data){
		$('#id_edit').val("");
		$('#name_edit').val("");
		$('#subject_id_edit').val("");
 ...
 $('#show_data').on('click','.item_delete',function(){
						...
						$('#Modal_Delete').modal('show');
						 $('[name="subjecttoclass_id_delete"]').val(delete_id);
						});
						
					//delete record to database
				  $('#btn_delete').on('click',function(){
							var delete_id2 = $('#subjecttoclass_id_delete').val();
							$.ajax({
								type : "POST",
								url  : "deletesubjecttoclass.php",
								dataType : "JSON",
								data : {id : delete_id2},
								success: function(data){
									$('#subjecttoclass_id_delete').val(""); 
