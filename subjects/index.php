...
<div id="wrapper">
    ...
    <!-- ng-class with current state name give you the ability to extended customization your view -->
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Take Computer Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/notes/">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
       ...
       <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Download Scheme of work</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/scheme-of-works"/>
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Fill your details to receive note and scheme</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/noteandscheme.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
