...
if(isset($_GET['id'])){
	...
	$data =  $server->getSchoollevelbyid($id);
...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updatesl.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School Level</h5>
                 ...
                 <div class="row" style="margin-bottom:40px">
                    ...
                    <a type="submit" href="https://www.thiscodeschool.com/confab/schoollevel/" id="btn_save" class="btn btn-danger col-md-6 col-sm-10"> Cancel &times;</a>
                    <button type="submit" name="schoollevel" id="btn_save" class="btn btn-primary col-md-6 col-sm-10">Update</button>
                  </div>
