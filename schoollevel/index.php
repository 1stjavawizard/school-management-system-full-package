...
<div id="wrapper">
                ...
                <tbody id="show_data">
                    <?php foreach($data as $d){?>
					   <tr> 
						   ...
						   <td> 
						      <a class="btn btn-primary" href="https://www.thiscodeschool.com/confab/schoollevel/updateschoollevel.php?id=<?php echo $d->id;?> ">Update</>
							   <a class="btn btn-danger" href="https://www.thiscodeschool.com/confab/schoollevel/deleteschoollevel.php?id=<?php echo $d->id;?>">Delete</>
						   </td>
					   </tr>
					<?php } ?>
                </tbody>
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="addschoollevel.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Add New School Level</h5>
                  ...
                  <div class="row">
                    ...
                    <button type="submit" name="schoollevel" id="btn_save" class="btn btn-primary col-md-offset-3 col-md-3 col-sm-offset-2 col-sm-10">Add School Level</button>
                  </div>
