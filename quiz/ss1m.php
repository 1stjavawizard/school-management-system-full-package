...
<div id="wrapper">
    ...
    <!-- ng-class with current state name give you the ability to extended customization your view -->
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
        <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeNCpPUgR4kiRh6hEAq90qnYXfM2ZBDIC8kVwyJ_kQ7ilvttg/viewform?embedded=true" width="100%" height="2463" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>	
                </div>
