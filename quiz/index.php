    ...
    <!-- ng-class with current state name give you the ability to extended customization your view -->
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Take Computer SS1 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss1.php">
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                           <h5>Take Computer SS2 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss2.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
       ...
       <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Take Computer SS3 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss3.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Take Mathematics SS1 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss1m.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
        ...
        <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                           <h5>Take Mathematics SS2 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss2m.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
       ...
       <div class="col-lg-4 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Take Mathematics SS3 Quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/quiz/ss3m.php">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
