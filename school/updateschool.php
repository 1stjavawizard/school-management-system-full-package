...
<div id="wrapper">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title" style="color:white">
                            <h5>Welcome! you are on students page!</h5>
                        </div>
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="https://www.thiscodeschool.com/confab/school/updateschool2.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School</h5>
				        ...
				        <div class="row">
						     <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="schoolname" id="schoolname" value="<?php echo $data->schoolname;?>" class="form-control">
							 ...
							 <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="regnumber" id="regnumber" value="<?php echo $data->regnumber;?>" class="form-control" readonly>
							   </div>
                              </div>
					         </div>
						</div>
                 ...
                 <div class="row" style="margin-bottom:40px">
                    ...
                    <a href="https://www.thiscodeschool.com/confab/school/" id="btn_save" class="btn btn-danger col-md-6 col-sm-10"> Cancel &times;</a>
                    <button type="submit" name="school" id="btn_save" class="btn btn-primary col-md-6 col-sm-10">Update</button>
                  </div>
