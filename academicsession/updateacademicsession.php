...
if(isset($_GET['id'])){
	...
	$data = $server->getacademicsessionbyid($id);
...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updateacademicsession2.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School Academicsession</h5>
				        ...
				        <div class="row">
							 ...
							 <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="description" id="description" value="<?php echo $data->description;?>" class="form-control">
							   </div>
                              </div>
					         </div>
						</div>
                  ...
                  <div class="row">
				    <a href="https://www.thiscodeschool.com/confab/academicsession/"  class="btn btn-primary col-md-3 col-sm-12">Cancel &times;</a>
                    <button type="submit" name="academicsession" id="academicsession" class="btn btn-primary col-md-3  col-sm-12">Update</button>
                  </div>
