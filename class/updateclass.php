...
if(isset($_GET['id'])){
	...
	$data = $server->getClasslevelbyid($id);
...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updateclass2.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School Classlevel</h5>
                  ...
                  <div class="row">
				    <a href="https://www.thiscodeschool.com/confab/class/"  class="btn btn-primary col-md-3 col-sm-12">Cancel &times;</a>
                    <button type="submit" name="session" id="btn_save" class="btn btn-primary col-md-3  col-sm-12">Update</button>
                  </div>
