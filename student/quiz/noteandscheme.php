...
<div id="wrapper">
    ...
    <!-- ng-class with current state name give you the ability to extended customization your view -->
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content" style="color:blue">
                            <h5>Please fill the information here</h5>
                        </div>
        ...
        <div class="row">
       <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSewX-b9mcZt4BjVh1ibyngmMSVVTdpbV3-Of6O6kXbT3mx14Q/viewform?embedded=true" width="100%" height="899" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                </div>
