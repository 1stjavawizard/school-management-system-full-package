...
<head>
	...
	<title>Confab secondary Quiz Board</title>
    ...
    <!-- ng-class with current state name give you the ability to extended customization your view -->
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title" style="color:blue">
                            <h5>Welcome <?php echo $user;?>,you are on students page!</h5>
                        </div>
                        <div class="ibox-content" style="color:blue">
                            <h5>Please click on anyone to enter a section!</h5>
                        </div>
                    ...
                    <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
									...
									<thead>
                                        ...
                                        <tr>
											<td>1</td>
											<td><h5>Computer SS1 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss1.php">Take the quiz</a></td>
										</tr>
										 <tr>
											<td>2</td>
											<td><h5>Computer SS2 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss2.php">Take the quiz</a></td>
										</tr>
										
										<tr>
											<td>3</td>
											<td><h5>Computer SS3 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss3.php">Take the quiz</a></td>
										</tr>
										
										<tr>
											<td>4</td>
											<td><h5>Mathematics SS1 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss1m.php">Take the quiz</a></td>
										</tr>
										
										<tr>
											<td>5</td>
											<td><h5>Mathematics SS2 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss2m.php">Take the quiz</a></td>
										</tr>
										
										<tr>
											<td>6</td>
											<td><h5>Mathematics SS3 Quiz</h5></td>											
										
											<td><a class="btn btn-sm btn-danger" href="https://www.thiscodeschool.com/confab/student/quiz/ss3m.php">Take the quiz</a></td>
										</tr>
