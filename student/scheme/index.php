...
<head>
	...
	<title>Students Scheme of work</title>
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="row">
					...
					<div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                              <div>
                                  <a href="https://www.thiscodeschool.com/confab/student/scheme/" class="btn btn-info col-sm-6 col-md-4 col-lg-2" id="cancelit" style="display:none">Cancel pdf</a>
                              </div>
                                   <canvas id="pdfviewer">
