    ...
    <!-- include navigation -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/student/scheme/">
     ...
     <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/student/quiz/">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/student/note/">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
