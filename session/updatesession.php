...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updatesession2.php">
                  ...
                  <div class="row">
				    <a href="https://www.thiscodeschool.com/confab/session/"  class="btn btn-primary col-md-3 col-sm-12">Cancel &times;</a>
