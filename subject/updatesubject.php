...
if(isset($_GET['id'])){
	...
	$data = $server->getSubjectbyid($id);
	
}
$schoollevel = $server->getSchoollevel();

if(isset(_POST['session'])){
	$data = $server->updateSchoollevel($_POST);
	if($data){
...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updatesubject2.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School Session</h5>
				        ...
				        <div class="row">
							 ...
							 <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="description" id="description" value="<?php echo $data->name;?>" class="form-control">
							   </div>
                              </div>
					         </div>
						</div>
						...
						<div class="row">
						     <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="category" id="category" class="form-control" value="<?php echo $data->category;?>">
							   </div>
                              </div>
					         </div>
						...
						<div class="row">
						     <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="shortname" id="shortname" class="form-control" value="<?php echo $data->shortname;?>">
							   </div>
                              </div>
					         </div>
                  ...
                  <div class="row">
				    <a href="https://www.thiscodeschool.com/confab/subject/"  class="btn btn-primary col-md-3 col-sm-12">Cancel &times;</a>
                    <button type="submit" name="subject_update" id="subject_update" class="btn btn-primary col-md-3  col-sm-12">Update</button>
                  </div>
