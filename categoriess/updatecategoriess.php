...
if(isset($_GET['id'])){
	...
	$data = $server->getcategoriessbyid($id);
...
<div id="wrapper">
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="updatecategoriess2.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Update School Category</h5>
                  ...
                  <div class="row">
				    <a href="https://www.thiscodeschool.com/confab/categoriess/"  class="btn btn-primary col-md-3 col-sm-12">Cancel &times;</a>
