...
$data = $server->getcategoriessItems();
...
<head>
	...
	<title>School Categoriess</title>
...
<div id="wrapper">
                    ...
                    <?php foreach($data as $d){?>
                     <?php if(!empty($d) && $d->name !=="" && $d->desciption !=="") {?>
					   <tr> 
						   ...
						   <td> 
						      <a class="btn btn-primary "href="https://www.thiscodeschool.com/confab/categoriess/updatecategoriess.php?id=<?php echo $d->id;?> ">Update</>
							   <a class="btn btn-primary" href="https://www.thiscodeschool.com/confab/categoriess/deletecategoriess.php?id=<?php echo $d->id;?>">Delete</>
						   </td>
					   </tr>
					<?php } ?>
					<?php }?>
    ...
    <div class="row">
	    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		   <form method="post" id="form" action="addcategoriess.php">
             
               
                  <div class="row">
                    <h5 class="col-md-9 col-md-offset-3" id="exampleModalLabel">Add New School Categoriess</h5>
                  ...
                  <div class="row">
                    ...
                    <button type="submit" name="categoriess" id="categoriess" class="btn btn-primary col-md-offset-3 col-md-3 col-sm-offset-2 col-sm-10">Add School Categoriess</button>
                  </div>
