...
<div id="wrapper">
    <!-- include navigation -->
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Write/Upload Scheme of work</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/teacher/scheme/">
     ...
     <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Write/Upload a quiz</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/teacher/quiz/">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Write/Upload Notes</h5>
                        </div>
                        <div class="ibox-content">
                            <a class="spiner-example" href="https://www.thiscodeschool.com/confab/teacher/note/">
                                <div class="sk-spinner sk-spinner-double-bounce">
                                    <div class="sk-double-bounce1"></div>
                                    <div class="sk-double-bounce2"></div>
                                </div>
