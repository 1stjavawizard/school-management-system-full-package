...
$assignteachertoclassandsubject = new Scheme();
...
<head>
	...
	<title>School Teachers Scheme Of Work</title>
       ...
       <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
				...
				<li>
                    <a href="#"> <i class="fa fa-graduation-cap"></i> <span class="nav-label">School Teachers</span>
        ...
        <div class="row">
		     <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<h1>School Teachers Scheme Of Work
					
					<div class="float-right"><a href="javascript:void(0);" class="btn btn-primary" data-toggle="modal" data-target="#Modal_Add"><span class="fa fa-plus"></span> Write Scheme</a></div>
				</h1>
             </div>
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="ibox ">
        ...
        <div class="row">
					...
					<div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                              <div>
                                  <a href="https://www.thiscodeschool.com/confab/teacher/scheme/" class="btn btn-info col-sm-6 col-md-4 col-lg-2" id="cancelit" style="display:none">Cancel pdf</a>
                              </div>
                                   <canvas id="pdfviewer">
						...
						<div class="row">
						     <div class="col-md-12 col-lg-12 col-sm-12">
							   <div class="form-group">						
								...
								<div class="col-md-10">
								  <input type="text" name="title" id="title" class="form-control" placeholder="Mathematics scheme for ss1 third term">
							   </div>
                              </div>
					         </div>
						     ...
						     <div class="col-md-6 col-lg-6 col-sm-12">
							   <div class="form-group">						
								...
								<input type="hidden" name="id_edit" id="id_edit">
								  <input type="text" name="title_edit" id="title_edit" class="form-control" placeholder="Mathematics scheme for ss1 third term">
							   </div>
                              </div>
					         </div>
    ...
    $(document).ready(function(){
	  ...
	  <!-- please edit from here -->		 		
		 function show(){
						$.ajax({
						   type  : 'ajax',
						   url   : 'selectallscheme.php', 
						   async : false,
						   dataType : 'json',
						    success:function(data){
							  var html = '';
									var i;       
									var paths = "/confab/teacher/scheme/uploads/schemes/";				
								 for(i=0; i<data.length; i++){ 
									...
									html += '<tr>'+
											...
											'<td>'+'<a href ="javascript:void(0);" onclick="preview(\''+paths+data[i].doc +'\')"'+' class="btn btn-info item_pre"'+' id="'+paths+data[i].doc+'"'+'>Preview</a>'+'</td>'+											
...
$('form#data2').on('submit',function(){
 ...
 var  units_id_edit=$('#units_id_edit').val();
 ...
 var  towhom_edit=$('#towhom_edit').val();
 var  createdby_edit=$('#createdby_edit').val();
 // data : {id:id_edit, user_id:user_id_edit,units_id:units_id_edit, session_id:session_id_edit, subject_id:subject_id_edit, academicsession_id:academicsession_id_edit, title:title_edit, content:content_edit, doc:doc_edit, towhom:towhom_edit, createdby:createdby_edit},
 var content=CKEDITOR.instances['content_edit'].getData();
         var formData = new FormData(this); 
         formData.append('id', id_edit);
         formData.append('user_id', user_id_edit);
         formData.append('units_id', units_id_edit);
         formData.append('subject_id', subject_id_edit);
         formData.append('subject_id', subject_id_edit);
          formData.append('academicsession_id', academicsession_id_edit);
         formData.append('title', title_edit);
         formData.append('doc', doc_edit);
         formData.append('towhom', towhom_edit);
         formData.append('createdby', createdby_edit);
